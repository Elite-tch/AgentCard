    ...
    <>
        ...
        >
          {JOBS.map((j) => (
            ...
            >
              ...
              >
                <a
                  href={`mailto:careers@agentcard.com?subject=Application: ${encodeURIComponent(j.title)}`}
                  style={{
                    display: 'inline-flex',
                    alignItems: 'center',
                    gap: '0.5rem',
      ...
      <section style={{ padding: '3rem 1.35rem 6rem' }}>
        ...
        >
          ...
          <a
            href="mailto:careers@agentcard.com?subject=Speculative application"
            style={{
              display: 'inline-flex',
              alignItems: 'center',
              gap: '0.55rem',
